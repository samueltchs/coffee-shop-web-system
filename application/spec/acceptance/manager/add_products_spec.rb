RSpec.describe "Add products" do
  context "given logged in as manager" do
    ...
    context "Adding a Drink Product" do
      it "then shows the new drink on the Products - Drinks page" do
        ...
        fill_in "Small_price", with:"4.2"
        fill_in "Regular_price", with:"4.5"
        fill_in "Small_cost", with:"1"
        fill_in "Regular_cost", with:"1.2"
        check "Availability"
        #small and regular size
        check "Small"
        check "Regular"
        #whole milk
        check "Whole Milk"
        ...
        expect(page).to have_content "Small Latte"
        expect(page).to have_content "Regular Latte"
      end
    end

    context "Adding a Bean Product" do
      it "then shows the new bean on the Products - Beans page" do
